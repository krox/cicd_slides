...
%  \begin{tikzpicture}[remember picture, overlay]
%     % Position the logos using node coordinates
%     \node[anchor=south wes^t, yshift=1cm, xshift=1cm] at (current page.south west) {\includegraphics[width=1.8cm]{logos/nvidia.png}};
%     \node[anchor=south west, yshift=1cm, xshift=4cm] at (current page.south west) {\includegraphics[width=1.8cm]{logos/eviden.png}};
%   \end{tikzpicture}
\end{frame}
